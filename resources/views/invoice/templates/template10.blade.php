...
@endif
                                        ...
                                        <div data-v-b8f60a0c="" class="col-33">
                                            <table data-v-b8f60a0c="" class="summary-table table-stripped">
                                                <tbody data-v-b8f60a0c="" style="position: relative">
                                                    ...
                                                    <tr data-v-b8f60a0c="">
                                                        <td data-v-b8f60a0c="" class="tu fwb"
                                                            ...
                                                            {{ __('Issue Date') }}:</td>
                                                        <td data-v-b8f60a0c="" class="text-right">
                                                            {{ \App\Models\Utility::dateFormat($settings, $invoice->issue_date) }}
                                                        </td>
                                                    </tr>
                                                    <tr data-v-b8f60a0c="">
                                                        <td data-v-b8f60a0c="" class="tu fwb"
