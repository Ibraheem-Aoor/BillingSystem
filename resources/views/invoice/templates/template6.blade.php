                                    ...
                                    <div data-v-4b3dcb8a="" class="col-33">
                                        <table data-v-4b3dcb8a="" class="summary-table table-stripped">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                ...
                                                <td data-v-4b3dcb8a="" class="text-right">{{\App\Models\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$invoice->due_date)}}</td>
                                            </tr>
                                            <tr class="ml-8" >
                                                <td class="">
                                           ...
                                           @if(!empty($customFields) && count($invoice->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr>
                                                        ...
                                                        <td  data-v-4b3dcb8a="" class="text-right"> {{!empty($invoice->customField)?$invoice->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
