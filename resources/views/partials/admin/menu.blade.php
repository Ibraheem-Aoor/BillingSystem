    ...
    <div class="scrollbar-inner">
        <div class="div-mega">
            <ul class="navbar-nav navbar-nav-docs">
                <li class="nav-item">
                    ...
                    @elseif(\Auth::guard('vender')->check())
                        <a href="{{ route('vender.dashboard') }}"
                            class="nav-link {{ Request::route()->getName() == 'vender.dashboard' ? ' active' : '' }}">
                            <i class="fas fa-fire"></i>{{ __('Dashboard') }}
                        </a>
                    @else
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ Request::segment(1) == 'productservice' || Request::segment(1) == 'product-category' || Request::segment(1) == 'car' || Request::segment(1) == 'driver' || Request::segment(1) == 'customer' || Request::segment(1) == 'supplier' ? 'show' : '' }}"
                        ...
                        <ul class="nav flex-column submenu-ul">
                            ...
                            <li
                                class="nav-item {{ Request::route()->getName() == 'supplier.index' || Request::route()->getName() == 'supplier.create' || Request::route()->getName() == 'supplier.edit' || Request::route()->getName() == 'supplier.show' ? ' active' : '' }}">
                                <a href="{{ route('supplier.index') }}" class="nav-link">{{ __('Supplier') }}</a>
                            </li>
                            <li
                                class="nav-item {{ Request::route()->getName() == 'driver.index' || Request::route()->getName() == 'driver.create' || Request::route()->getName() == 'driver.edit' || Request::route()->getName() == 'driver.show' ? ' active' : '' }}">
                                <a href="{{ route('driver.index') }}" class="nav-link">{{ __('Driver') }}</a>
                            </li>
                            <li
                                class="nav-item {{ Request::route()->getName() == 'customer.index' || Request::route()->getName() == 'customer.create' || Request::route()->getName() == 'customer.edit' || Request::route()->getName() == 'customer.show' ? ' active' : '' }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::segment(1) == 'price-list' || Request::segment(1) == 'sale' ? ' active' : 'collapsed' }}"
                        href="#navbar-transaction" data-toggle="collapse" role="button"
                        aria-expanded="{{ Request::segment(1) == 'productservice' ? 'true' : 'false' }}"
                ...
                {{-- @if (Gate::check('manage proposal'))
                    <li class="nav-item">
                        <a href="{{ route('proposal.index') }}"
                            class="nav-link {{ Request::segment(1) == 'proposal' ? 'active' : '' }}">
                ...
                {{-- @if (Gate::check('manage bank account') || Gate::check('manage transfer'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) == 'bank-account' || Request::segment(1) == 'transfer' ? ' active' : 'collapsed' }}"
                            href="#navbar-banking" data-toggle="collapse" role="button"
                            aria-expanded="{{ Request::segment(1) == 'bank-account' || Request::segment(1) == 'transfer' ? 'true' : 'false' }}"
                            aria-controls="navbar-banking">
                            <i class="fas fa-university"></i>{{ __('Banking') }}
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse {{ Request::segment(1) == 'bank-account' || Request::segment(1) == 'transfer' ? 'show' : '' }}"
                            id="navbar-banking">
                            <ul class="nav flex-column submenu-ul">
                                @can('manage bank account')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'bank-account.index' || Request::route()->getName() == 'bank-account.create' || Request::route()->getName() == 'bank-account.edit' ? ' active' : '' }}">
                                ...
                                @can('manage transfer')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'transfer.index' || Request::route()->getName() == 'transfer.create' || Request::route()->getName() == 'transfer.edit' ? ' active' : '' }}">
                ...
                @if (Gate::check('manage invoice') || Gate::check('manage revenue') || Gate::check('manage credit note'))
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' ? 'show' : '' }}"
                            id="navbar-income">
                            <ul class="nav flex-column submenu-ul">
                                @can('manage invoice')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show' ? ' active' : '' }}">
                                        <a href="{{ route('invoice.index') }}" class="nav-link">{{ __('Invoice') }}</a>
                                    </li>
                                @endcan
                                @can('manage revenue')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'revenue.index' || Request::route()->getName() == 'revenue.create' || Request::route()->getName() == 'revenue.edit' ? ' active' : '' }}">
                                        <a href="{{ route('revenue.index') }}" class="nav-link">{{ __('Revenue') }}</a>
                                    </li>
                                @endcan
                                @can('manage credit note')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'credit.note' ? ' active' : '' }}">
                ...
                {{-- @if (Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' ? ' active' : 'collapsed' }}"
                            href="#navbar-expense" data-toggle="collapse" role="button"
                            aria-expanded="{{ Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' ? 'true' : 'false' }}"
                            aria-controls="navbar-expense">
                            <i class="fas fa-money-bill-wave-alt"></i>{{ __('Expense') }}
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse {{ Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' ? 'show' : '' }}"
                            id="navbar-expense">
                            <ul class="nav flex-column submenu-ul">
                                @can('manage bill')
                                    <li
                ...
                {{-- @if (Gate::check('manage chart of account') || Gate::check('manage journal entry') || Gate::check('balance sheet report') || Gate::check('ledger report') || Gate::check('trial balance report'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' || Request::segment(2) == 'balance-sheet' || Request::segment(2) == 'trial-balance' ? ' active' : 'collapsed' }}"
                            href="#navbar-double-entry" data-toggle="collapse" role="button"
                            aria-expanded="{{ Request::segment(1) == 'bill' ? 'true' : 'false' }}"
                            aria-controls="navbar-double-entry">
                            <i class="fas fa-balance-scale"></i>{{ __('Double Entry') }}
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse {{ Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' || Request::segment(2) == 'balance-sheet' || Request::segment(2) == 'trial-balance' ? 'show' : '' }}"
                            id="navbar-double-entry">
                            <ul class="nav flex-column submenu-ul">
                                @can('manage chart of account')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'chart-of-account.index' ? ' active' : '' }}">
                                ...
                                @can('manage journal entry')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'journal-entry.index' || Request::route()->getName() == 'journal-entry.show' ? ' active' : '' }}">
                ...
                {{-- @if (Gate::check('manage goal'))
                    <li class="nav-item">
                        <a href="{{ route('goal.index') }}"
                            class="nav-link {{ Request::segment(1) == 'goal' ? 'active' : '' }}">
                ...
                @if (Gate::check('income report') ||
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ (Request::segment(1) == 'report' || Request::segment(1) == 'transaction') && Request::segment(2) != 'ledger' && Request::segment(2) != 'balance-sheet' && Request::segment(2) != 'trial-balance' ? 'show' : '' }}"
                            id="navbar-reports">
                            <ul class="nav flex-column submenu-ul">
                                ...
                                @can('income report')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'report.income.summary' ? ' active' : '' }}">
                                ...
                                @can('expense report')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'report.expense.summary' ? ' active' : '' }}">
                                ...
                                @can('income vs expense report')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'report.income.vs.expense.summary' ? ' active' : '' }}">
                                ...
                                @can('tax report')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'report.tax.summary' ? ' active' : '' }}">
                                ...
                                @can('loss & profit report')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'report.profit.loss.summary' ? ' active' : '' }}">
                                ...
                                @can('invoice report')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'report.invoice.summary' ? ' active' : '' }}">
                                ...
                                @can('bill report')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'report.bill.summary' ? ' active' : '' }}">
                ...
                {{-- @if (Gate::check('manage constant tax') || Gate::check('manage constant category') || Gate::check('manage constant unit') || Gate::check('manage constant payment method') || Gate::check('manage constant custom field') || Gate::check('manage constant chart of account'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' ? ' active' : 'collapsed' }}"
                            ...
                            aria-expanded="{{ Request::segment(1) == 'taxes' ||
                        ...
                        <div class="collapse {{ Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' ? 'show' : '' }}"
                            id="navbar-constant">
                            <ul class="nav flex-column submenu-ul">
                                ...
                                @can('manage constant unit')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'product-unit.index' ? ' active' : '' }}">
                                ...
                                @can('manage constant custom field')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'custom-field.index' ? 'active' : '' }}">
